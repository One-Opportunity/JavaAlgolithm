...
public class ArrayStack implements Stack {
	...
	/**
	 * return top element of stack throw EmptyStackException when the stack is empty
	 */
	public Object peek() {
		if (isEmpty())
	...
	/**
	 * remove top element of stack and return it throw EmptyStackException when the
	 * stack is empty
	 */
	public Object pop() {
		if (isEmpty())
